...
export type AccordionRootProps = Omit<ComponentProps<typeof BaseAccordion.Root>, 'className'> & {
  className?: string
}
...
export type AccordionItemProps = Omit<ComponentProps<typeof BaseAccordion.Item>, 'className'> & {
  title: ReactNode
  children: ReactNode
  className?: string
}
...
export function AccordionItem({ title, children, className, ...props }: AccordionItemProps) {
  return (
    <BaseAccordion.Item className={cn('border-b border-default', className)} {...props}>
      <BaseAccordion.Header>
        ...
        >
          ...
          <CaretDownIcon
            size={20}
            className={cn('shrink-0 text-default transition-[rotate] duration-200', 'group-data-panel-open:rotate-180')}
          />
        </BaseAccordion.Trigger>
      </BaseAccordion.Header>
      <BaseAccordion.Panel
